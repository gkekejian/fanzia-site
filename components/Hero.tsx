      ...
      <div className="relative z-10 border-b border-white/10 bg-brand-red">
        <div className="container flex h-9 items-center justify-between font-display text-[11px] uppercase tracking-[0.28em] text-white">
          <div className="flex items-center gap-3">
            ...
            <span>Glendale &amp; Southern California</span>
          </div>
          <div className="hidden md:block">By the Fans. For the Fans.</div>
          <div>Est. 2021</div>
        </div>
      </div>
      ...
      <div className="container relative grid gap-0 lg:grid-cols-12 lg:items-stretch">
        ...
        >
          <span className="inline-flex items-center gap-3 border border-brand-red bg-black px-3 py-1.5 font-display text-[11px] uppercase tracking-[0.3em] text-brand-red">
            ...
            Trading Card Retail &amp; Wholesale
          </span>

          <h1 className="mt-8 display text-[3.6rem] leading-[0.95] text-white sm:text-7xl md:text-[6.5rem] lg:text-[6.5rem] xl:text-[7.5rem]">
            <span className="block">By the Fans.</span>
            <span className="block text-brand-red">For the Fans.</span>
          </h1>
          ...
          <dl className="mt-14 grid max-w-2xl grid-cols-3 gap-0 border-t border-white/10">
            {[
              { v: "2021", k: "Established" },
              { v: "CA", k: "Glendale storefront" },
              { v: "2+", k: "Retail locations" },
            ].map((s, i) => (
              <div
                key={s.k}
        ...
        >
          {/* {{TODO: hero image}} — replace this panel with storefront or
              card product photography once shot. Keeping the wordmark
              treatment as a placeholder in the meantime. */}
          <WavePattern
